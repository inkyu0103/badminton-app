    ...
    <div className="flex flex-col p-4 gap-y-4">
      ...
      <section>
        ...
        <ul className="pl-4 list-disc">
          ...
          <li>5만원 미만으로 라켓을 파시려는 경우</li>
        </ul>
        <h3 className="mt-2 font-bold">무게</h3>
        <p>현재 나오는 라켓 무게는 3가지 종류가 있습니다.</p>
        <p>
          처음 입문하시는 분이라면
        ...
        <p>
          ...
          <strong className="text-blue-500"> 헤드 라이트</strong>를
          추천드립니다.
        </p>
      ...
      <section>
        <h2 className="text-2xl font-bold">신발</h2>
        <h3>가격</h3>
        <h3></h3>
      </section>
    </div>
